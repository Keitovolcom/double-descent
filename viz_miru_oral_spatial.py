...
def spatial():
    ...
    save_dir = "vizualize/miru_oral"
    svg_path = os.path.join(save_dir, f"spatial_instability_gattai{mode}.svg")
    pdf_path = os.path.join(save_dir, f"spatial_instability_gattai{mode}.pdf")

    # SVG
    plot_aggregate_instability_multi(
        stats_dfs=stats_list,
        labels=labels,
        colors=colors,
        xlabel="epoch",
        ylabel="Spatial Instability",
